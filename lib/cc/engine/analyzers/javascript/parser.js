...
try {
  engineConfig = require("/config.json");
} catch (e) {
  engineConfig = {config: {}};
}

var babylonPlugins = engineConfig.config.javascript_plugins || ["jsx", "objectRestSpread"];
...
process.stdin.on('end', function() {
  var ast = babylon.parse(source, { plugins: babylonPlugins, strictMode: false, sourceType: "module" });
